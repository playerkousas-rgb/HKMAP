...
- 城市定向常用比例：**1:2 500、1:4 000、1:5 000、1:7 500、1:10 000、1:15 000、1:20 000**；亦可輸入 **1:500–1:100 000 自訂比例**
- 可 **LOCK 比例**（停用縮放，比例不會漂移）；白紙上就是該比例印出
- **設計＝列印（WYSIWYG）**：中央白紙就是實際列印頁（A3/A4/A5、直向／橫向），紙外不會印
- 路線 JSON／GPX 匯出、匯入、列印檢查點說明表
- 本機暫存、返回／重做、量距、城市建築／街道特徵標記
